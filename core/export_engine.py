...
class ExportEngine:
    ...
    def _write_metadata(
        ...
        data = [
            ...
            [],
            ["【配置信息】", ""],
            ["主键字段", config_info.get("key_columns", "")],
            ["数值字段", config_info.get("value_columns", "")],
            ["透视列", config_info.get("pivot_column", "未使用")],
            ["差值公式", config_info.get("diff_formula", "手工数量 - 系统总计")],
            [],
            ["【颜色说明】", ""],
            ["绿色", "✓ 一致"],
            ["浅黄绿", "↑ 手工多（差值>0）"],
