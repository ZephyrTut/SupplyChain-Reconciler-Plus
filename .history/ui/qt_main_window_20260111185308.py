...
class QtMainWindow(QMainWindow):
    ...
    def _export_system_preview(self):
        ...
        if system_filters:
            ...
            df_filtered = CompareEngine.filter_data(df_filtered, filter_tuples)
        ...
        if pivot_col:
            ...
            if system_key_cols and system_val_col:
                ...
                try:
                    # 执行透视
                    pivot_df = CompareEngine.pivot_and_sum(
                        system_with_key, "__KEY__", pivot_col, system_val_col, pivot_values
                    )
