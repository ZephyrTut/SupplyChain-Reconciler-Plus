...
class MainWindow:
    ...
    def _create_step3_frame(self):
        ...
        y_scroll = ttk.Scrollbar(table_frame, orient="vertical", command=self.result_tree.yview, bootstyle="secondary-round")
        x_scroll = ttk.Scrollbar(table_frame, orient="horizontal", command=self.result_tree.xview, bootstyle="secondary-round")
