...
class ColumnCleanRow(DynamicRow):
    ...
    def _setup_ui(self):
        ...
        self.custom_edit.setMaximumWidth(120)
        self.custom_edit.setStyleSheet("QLineEdit { font-size: 11px; padding: 2px 4px; }")
        ...
        for preset_name, _ in self.CLEAN_PRESETS:
            ...
            cb.setStyleSheet("QCheckBox { color: #333; font-size: 11px; }")
