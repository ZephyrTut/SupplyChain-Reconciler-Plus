...
class ResultPreview(ttk.Frame):
    ...
    def __init__(self, parent):
        ...
        ttk.Label(header_frame, text="📊 结果预览", font=("", 11, "bold")).pack(side="left")
        
        self.status_label = ttk.Label(header_frame, text="", bootstyle="secondary", font=("", 9))
        ...
        ttk.Label(manual_outer, text="📄 手工表样例（前5条）", font=("", 9, "bold")).pack(anchor="w")
        ...
        ttk.Label(system_outer, text="🗄️ 系统表样例（前5条）", font=("", 9, "bold")).pack(anchor="w")
