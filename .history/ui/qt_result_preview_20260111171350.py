...
class QtResultPreview(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.preview_header.setFont(QFont("Microsoft YaHei", 10, QFont.Weight.Bold))
        ...
        self.formula_label.setStyleSheet("color: #e65100; background: transparent; border: none; padding: 0;")
        ...
        preview_content_layout.addWidget(self.preview_table, 1)
        ...
        preview_layout.addWidget(self.preview_content, 1)  # 内容区域可扩展
        layout.addWidget(self.preview_section)  # 不设置stretch，让它自然大小
