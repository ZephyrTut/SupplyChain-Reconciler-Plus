...
class TestCompareEngine(unittest.TestCase):
    ...
    def test_aggregate_with_pivot(self):
        ...
        self.assertIn("数量_已发货", agg_df.columns)
        self.assertIn("数量_已关闭", agg_df.columns)
        self.assertIn("数量_总计", agg_df.columns)
        self.assertEqual(agg_df.loc["A001", "数量_总计"], 80)
    ...
    def test_diff_formula(self):
        ...
        manual_data.set_index("__KEY__", inplace=True)
        ...
        system_data.set_index("__KEY__", inplace=True)
...
class TestIntegration(unittest.TestCase):
    ...
    def test_full_workflow(self):
        ...
        self.assertIn("系统数量_总计", system_agg.columns)
