...
| [docs/01-快速开始.md](docs/01-快速开始.md) | 5分钟上手 |
| [docs/03-数据导入.md](docs/03-数据导入.md) | Excel导入 |
| [docs/04-主键配置.md](docs/04-主键配置.md) | 复合主键 |
| [docs/05-数据清洗.md](docs/05-数据清洗.md) | 正则清洗 |
| [docs/06-筛选条件.md](docs/06-筛选条件.md) | 条件筛选 |
| [docs/07-透视聚合.md](docs/07-透视聚合.md) | 透视处理 |
| [docs/14-核心引擎API.md](docs/14-核心引擎API.md) | API参考 |
| [docs/19-常见问题.md](docs/19-常见问题.md) | FAQ |

### AI Agent 开发约束

- [AGENT.md](AGENT.md) - Agent专用约束文档
